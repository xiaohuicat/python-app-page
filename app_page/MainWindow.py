...
from .utils import assetsUrl, setShadowEffect, assetsRead, s2t, blur_image
...
class MainWindow(QMainWindow):
  ...
  def setAppStyle(self):
    ...
    setting = Param(self.getSoftwarePath("userPath", "setting.json"), default_theme)
